...
// InstallationRepository defines the interface for GitLab installation persistence.
type InstallationRepository interface {
	...
	FindByGroupPath(ctx context.Context, groupPath string) (*Installation, error)
...
func (s *stubInstallationRepository) FindByGroupPath(ctx context.Context, groupPath string) (*Installation, error) {
	return nil, nil
}
